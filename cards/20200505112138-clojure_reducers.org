:PROPERTIES:
:ID:       ec0e78c6-a0ce-4244-bf23-004734d85adc
:ROAM_REFS: https://www.braveclojure.com/quests/reducers/intro/
:ROAM_ALIASES: clj-hpc parallel-programming-in-clojure-with-reducers reducers
:END:
#+TITLE: Parallel Programming in Clojure with Reducers
#+OPTIONS: toc:nil
#+DATE: 2020-05-05
#+filetags: :clj:book:reducers:parallelism:concurrency:hpc:
